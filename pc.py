...
verctorstore_from_docs = PineconeVectorStore.from_documents(
    documents,
    index_name="game-ranking",
...
# 3. Create chain
rag_chain = (
    {"context": verctorstore_from_docs.as_retriever() | format_docs, "question": RunnablePassthrough()}
    | prompt
    | model
    | StrOutputParser()
)
